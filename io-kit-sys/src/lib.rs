...
pub type IOServiceMatchingCallback = Option<unsafe extern "C" fn(refcon: *mut c_void,
                                                                 iterator: io_iterator_t)
                                                                >;

pub type IOServiceInterestCallback = Option<unsafe extern "C" fn(refcon: *mut c_void,
...
extern "C" {
    ...
    pub fn IONotificationPortSetDispatchQueue(notify: IONotificationPortRef,
                                              queue: dispatch_queue_t);

    pub fn IODispatchCalloutFromMessage(unused: *mut c_void,
...
extern "C" {
    pub fn IOServiceGetMatchingService(masterPort: mach_port_t,
                                       matching: CFDictionaryRef)
                                       -> io_service_t;

    pub fn IOServiceGetMatchingServices(masterPort: mach_port_t,
                                        matching: CFDictionaryRef,
                                        existing: *mut io_iterator_t)
                                        -> kern_return_t;


    pub fn IOServiceAddNotification(masterPort: mach_port_t,
    ...
    pub fn IOServiceAddMatchingNotification(notifyPort: IONotificationPortRef,
                                            notificationType: *mut c_char,
                                            matching: CFDictionaryRef,
    ...
    pub fn IOServiceAddInterestNotification(notifyPort: IONotificationPortRef,
                                            service: io_service_t,
    ...
    pub fn IOServiceMatchPropertyTable(service: io_service_t,
                                       matching: CFDictionaryRef,
    ...
    pub fn IOServiceWaitQuiet(service: io_service_t,
                              waitTime: *mut mach_timespec_t)
                              -> kern_return_t;

    pub fn IOKitGetBusyState(masterPort: mach_port_t, busyState: *mut u32) -> kern_return_t;

    pub fn IOKitWaitQuiet(masterPort: mach_port_t,
                          waitTime: *mut mach_timespec_t)
                          -> kern_return_t;

    pub fn IOServiceOpen(service: io_service_t,
...
extern "C" {
    ...
    pub fn IOConnectSetNotificationPort(connect: io_connect_t,
                                        type_: u32,
                                        port: mach_port_t,
                                        reference: usize)
                                        -> kern_return_t;

    pub fn IOConnectMapMemory(connect: io_connect_t,
                              memoryType: u32,
    ...
    pub fn IOConnectMapMemory64(connect: io_connect_t,
                                memoryType: u32,
                                intoTask: task_port_t,
                                atAddress: *mut mach_vm_address_t,
                                ofSize: *mut mach_vm_size_t,
    ...
    pub fn IOConnectUnmapMemory(connect: io_connect_t,
                                memoryType: u32,
                                fromTask: task_port_t,
                                atAddress: mach_vm_address_t)
                                -> kern_return_t;

    pub fn IOConnectUnmapMemory64(connect: io_connect_t,
                                  memoryType: u32,
                                  fromTask: task_port_t,
                                  atAddress: mach_vm_address_t)
                                  -> kern_return_t;
    ...
    pub fn IOConnectSetCFProperty(connect: io_connect_t,
...
extern "C" {
    pub fn IOConnectCallMethod(connection: mach_port_t,
                               selector: u32,
                               input: *const u64,
                               inputCnt: u32,
    ...
    pub fn IOConnectCallAsyncMethod(connection: mach_port_t,
                                    selector: u32,
...
extern "C" {
    ...
    pub fn IOConnectCallAsyncStructMethod(connection: mach_port_t,
                                          selector: u32,
                                          wake_port: mach_port_t,
                                          reference: *mut u64,
                                          referenceCnt: u32,
    ...
    pub fn IOConnectCallScalarMethod(connection: mach_port_t,
                                     selector: u32,
                                     input: *const u64,
                                     inputCnt: u32,
                                     output: *mut u64,
    ...
    pub fn IOConnectCallAsyncScalarMethod(connection: mach_port_t,
                                          selector: u32,
                                          wake_port: mach_port_t,
                                          reference: *mut u64,
                                          referenceCnt: u32,
...
extern "C" {
    ...
    pub fn IOConnectTrap2(connect: io_connect_t,
                          index: u32,
                          p1: usize,
                          p2: usize)
                          -> kern_return_t;

    pub fn IOConnectTrap3(connect: io_connect_t,
                          index: u32,
                          p1: usize,
                          p2: usize,
                          p3: usize)
    ...
    pub fn IOConnectTrap4(connect: io_connect_t,
                          index: u32,
                          p1: usize,
                          p2: usize,
                          p3: usize,
    ...
    pub fn IOConnectTrap5(connect: io_connect_t,
                          index: u32,
                          p1: usize,
                          p2: usize,
                          p3: usize,
    ...
    pub fn IOConnectTrap6(connect: io_connect_t,
                          index: u32,
                          p1: usize,
                          p2: usize,
                          p3: usize,
...
extern "C" {
    ...
    pub fn IORegistryEntryFromPath(masterPort: mach_port_t,
                                   path: *mut c_char)
                                   -> io_registry_entry_t;

    pub fn IORegistryEntryCopyFromPath(masterPort: mach_port_t,
                                       path: CFStringRef)
                                       -> io_registry_entry_t;
}
...
extern "C" {
    pub fn IORegistryCreateIterator(masterPort: mach_port_t,
                                    plane: *mut c_char,
                                    options: IOOptionBits,
                                    iterator: *mut io_iterator_t)
                                    -> kern_return_t;

    pub fn IORegistryEntryCreateIterator(entry: io_registry_entry_t,
                                         plane: *mut c_char,
                                         options: IOOptionBits,
                                         iterator: *mut io_iterator_t)
                                         -> kern_return_t;
...
extern "C" {
    ...
    pub fn IORegistryEntryGetNameInPlane(entry: io_registry_entry_t,
                                         plane: *mut c_char,
                                         name: *mut c_char)
                                         -> kern_return_t;

    pub fn IORegistryEntryGetLocationInPlane(entry: io_registry_entry_t,
                                             plane: *mut c_char,
                                             location: *mut c_char)
                                             -> kern_return_t;

    pub fn IORegistryEntryGetPath(entry: io_registry_entry_t,
                                  plane: *mut c_char,
                                  path: *mut c_char)
                                  -> kern_return_t;
    ...
    pub fn IORegistryEntryGetRegistryEntryID(entry: io_registry_entry_t,
                                             entryID: *mut u64)
                                             -> kern_return_t;
    ...
    pub fn IORegistryEntryCreateCFProperty(entry: io_registry_entry_t,
                                           key: CFStringRef,
                                           allocator: CFAllocatorRef,
                                           options: IOOptionBits)
                                           -> CFTypeRef;

    pub fn IORegistryEntrySearchCFProperty(entry: io_registry_entry_t,
                                           plane: *mut c_char,
                                           key: CFStringRef,
                                           allocator: CFAllocatorRef,
                                           options: IOOptionBits)
    ...
    #[deprecated(since="0.1.0", note="please use `IORegistryEntryCreateCFProperty` instead")]
    pub fn IORegistryEntryGetProperty(entry: io_registry_entry_t,
                                      propertyName: *mut c_char,
                                      buffer: *mut c_char,
                                      size: *mut u32)
                                      -> kern_return_t;

    pub fn IORegistryEntrySetCFProperties(entry: io_registry_entry_t,
                                          properties: CFTypeRef)
                                          -> kern_return_t;

    pub fn IORegistryEntrySetCFProperty(entry: io_registry_entry_t,
                                        propertyName: CFStringRef,
                                        property: CFTypeRef)
                                        -> kern_return_t;

    pub fn IORegistryEntryGetChildIterator(entry: io_registry_entry_t,
                                           plane: *mut c_char,
                                           iterator: *mut io_iterator_t)
                                           -> kern_return_t;

    pub fn IORegistryEntryGetChildEntry(entry: io_registry_entry_t,
                                        plane: *mut c_char,
                                        child: *mut io_registry_entry_t)
                                        -> kern_return_t;

    pub fn IORegistryEntryGetParentIterator(entry: io_registry_entry_t,
                                            plane: *mut c_char,
                                            iterator: *mut io_iterator_t)
                                            -> kern_return_t;

    pub fn IORegistryEntryGetParentEntry(entry: io_registry_entry_t,
                                         plane: *mut c_char,
...
extern "C" {
    ...
    pub fn IOBSDNameMatching(masterPort: mach_port_t,
                             options: u32,
                             bsdName: *const c_char)
                             -> CFMutableDictionaryRef;

    pub fn IOOpenFirmwarePathMatching(masterPort: mach_port_t,
                                      options: u32,
                                      path: *const c_char)
                                      -> CFMutableDictionaryRef;
    ...
    pub fn IOServiceOFPathToBSDName(masterPort: mach_port_t,
...
pub type IOAsyncCallback1 = Option<unsafe extern "C" fn(refcon: *mut c_void,
                                                        result: IOReturn,
                                                        arg0: *mut c_void)
                                                       >;

pub type IOAsyncCallback2 = Option<unsafe extern "C" fn(refcon: *mut c_void,
                                                        result: IOReturn,
                                                        arg0: *mut c_void,
                                                        arg1: *mut c_void)
                                                       >;

pub type IOAsyncCallback = Option<unsafe extern "C" fn(refcon: *mut c_void,
                                                       result: IOReturn,
                                                       args: *mut *mut c_void,
                                                       numArgs: u32)
                                                      >;
